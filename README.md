...
**Average Return = Sum of Daily Returns / Number of Observations**
...
**Sample Variance = Σ(Return − Average Return)² / (n − 1)**
...
- `RA, RB` = individual asset returns
...
**Portfolio Variance = (wA² × σA²) + (wB² × σB²) + (2 × wA × wB × Covariance A,B)**
